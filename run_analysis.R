...
y_test_labels <- read.table("./UCI HAR Dataset/test/y_test.txt") #reading the test set
...
y_train_labels <- read.table("./UCI HAR Dataset/train/y_train.txt") #reading the training set
